...
public final class GeoTiffMetadata2CRSAdapter {
    ...
    public GeoTiffMetadata2CRSAdapter(Hints hints) {
        ...
        this.hints.put(Hints.DEFAULT_COORDINATE_REFERENCE_SYSTEM, FeatureReader.DefaultCRS);
     ...
     *
     * This GeoKey defines the general type of model Coordinate system used, and to which the raster space
     * will be transformed:
     * unknown,
     * Geocentric (rarely used),
     * Geographic,
     * Projected Coordinate System, or
     * user defined. If the coordinate system is a PCS, then only the PCS code need be specified.
     * If the coordinate system does not fit into one of the standard registered PCS'S,
     * but it uses one of the standard projections and datums, then it should be documented
     * as a PCS model with "userdefined" type, requiring the specification of projection parameters, etc.
     */
