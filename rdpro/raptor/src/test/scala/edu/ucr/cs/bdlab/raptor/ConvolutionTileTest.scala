...
import edu.ucr.cs.bdlab.beast.geolite.{Feature, IFeature, ITile, RasterFeature, RasterMetadata}
...
class ConvolutionTileTest extends AnyFunSuite with ScalaSparkTest {
  ...
  test("Single band convolution") {
    ...
    val tile2 = new MemoryTile[Float](1, metadata, RasterFeature.create(Array("fileName"),Array("testFile.tif")))
    tile2.setPixelValue(10, 0, 5.0f)
    tile2.setPixelValue(10, 9, 5.0f)
    val convWindow2 = new ConvolutionTileSingleBand(0, metadata, tile2.rasterFeature,1, Array.fill(9)(0.11f), tile2.tileID)
  ...
  test("Multi band convolution") {
    ...
    val tile1 = new MemoryTile[Array[Float]](0, metadata, RasterFeature.create(Array("fileName"),Array("testFile.tif")))
    ...
    val convWindow2 = new ConvolutionTileMultiBand(0, metadata, RasterFeature.create(Array("fileName"),Array("testFile.tif")),2, 1, Array.fill(9)(0.11f), tile2.tileID)
    convWindow2.addTile(tile2)
