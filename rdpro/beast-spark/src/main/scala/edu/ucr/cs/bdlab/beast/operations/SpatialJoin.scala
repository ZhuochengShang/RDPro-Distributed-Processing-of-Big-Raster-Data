...
import edu.ucr.cs.bdlab.beast.cg.{GeometryQuadSplitter, PlaneSweepSpatialJoinIterator, SpatialPartitioner}
...
import edu.ucr.cs.bdlab.beast.indexing.{CellPartitioner, IndexHelper}
