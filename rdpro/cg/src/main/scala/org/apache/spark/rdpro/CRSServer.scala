 ...
 */
package org.apache.spark.rdpro
...
object CRSServer extends Logging {
   ...
   */
  private[rdpro] val crsCache: scala.collection.mutable.Map[CoordinateReferenceSystem, Int] =
   ...
   */
  private[rdpro] val sridCache: scala.collection.mutable.Map[Int, CoordinateReferenceSystem] =
   ...
   */
  def stopOnExit(sc: SparkContext): Unit = {
  ...
  def stopOnExit(jsc: JavaSparkContext): Unit = stopOnExit(jsc.sc)
  ...
  val insertServlet: javax.servlet.Servlet = new javax.servlet.http.HttpServlet() {
    override def doPost(request: HttpServletRequest, response: HttpServletResponse): Unit = {
      ...
      try {
        ...
        val crs: CoordinateReferenceSystem = in.readObject().asInstanceOf[CoordinateReferenceSystem]
