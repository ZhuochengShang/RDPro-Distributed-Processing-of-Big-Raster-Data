...
import edu.school.org.lab.rdpro.JavaSpatialRDDHelper;
import edu.school.org.lab.rdpro.JavaSpatialSparkContext;
...
public class beastJava {
  public static void main(String[] args) {
    // Initialize Spark
    SparkConf conf = new SparkConf().setAppName("rdpro Example");
