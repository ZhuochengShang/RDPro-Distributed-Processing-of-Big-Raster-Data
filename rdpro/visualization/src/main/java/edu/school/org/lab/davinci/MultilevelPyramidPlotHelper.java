...
import edu.school.org.lab.rdpro.io.CSVEnvelopeEncoder;
import edu.school.org.lab.rdpro.io.FeatureReader;
import edu.school.org.lab.rdpro.io.SpatialFileRDD;
import edu.school.org.lab.rdpro.io.SpatialOutputFormat;
...
public class MultilevelPyramidPlotHelper {
  ...
  public static long getTileSize(AbstractHistogram h, double buffer, int z, int x, int y) {
    ...
    if (buffer > 0) {
      ...
      return (long) (fractionOfGridCellCoveredByTile * fractionOfGridCellCoveredByTile *
