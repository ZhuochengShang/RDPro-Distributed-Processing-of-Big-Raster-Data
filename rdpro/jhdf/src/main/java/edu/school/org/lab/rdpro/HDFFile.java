...
public class HDFFile implements Closeable {
  ...
  /**
   * Initializes a new HDF file from a given file path.
   * @param filePath Path to the HDF file
   * @throws IOException
   */
  public HDFFile(String filePath) throws IOException {
    Path path = new Path(filePath);
    FileSystem fs = path.getFileSystem(new Configuration());
    this.init(fs.open(path));
  }

  public void init(FSDataInputStream inStream) throws IOException {
