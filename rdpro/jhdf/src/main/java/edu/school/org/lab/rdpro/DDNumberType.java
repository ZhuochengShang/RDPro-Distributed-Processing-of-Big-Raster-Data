...
public class DDNumberType extends DataDescriptor {
  ...
  public int getDataSize() throws IOException {
    lazyLoad();
    switch (type) {
    case HDFConstants.DFTNT_UINT8: return 1;
    case HDFConstants.DFTNT_INT16:
    case HDFConstants.DFTNT_UINT16: return 2;
    case HDFConstants.DFTNT_INT32: return 4;
    case HDFConstants.DFTNT_FLOAT32: return 4;
    case HDFConstants.DFTNT_FLOAT64: return 8;
