...
import edu.school.org.lab.rdpro.io.shapefile.ShapefileFeatureReader
import edu.school.org.lab.rdpro.cg.SpatialPartitioner
import edu.school.org.lab.rdpro.common.BeastOptions
import edu.school.org.lab.rdpro.generator.{RandomSpatialRDD, UniformDistribution}
import edu.school.org.lab.rdpro.indexing.{GridPartitioner, IndexHelper}
import edu.school.org.lab.rdpro.io.SpatialFileRDD.FilePartition
import edu.school.org.lab.rdpro.io.shapefile.ShapefileFeatureReader
...
class SpatialFileRDDTest extends FunSuite with ScalaSparkTest {
  ...
  test("Detect the input") {
    ...
    inputPath = makeResourceCopy("/usa-major-cities")
    features = new SpatialFileRDD(sparkContext, inputPath.getPath)
    assertResult(classOf[ShapefileFeatureReader])(features.featureReaderClass)
  }
