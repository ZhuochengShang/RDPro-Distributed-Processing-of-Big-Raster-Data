...
import edu.school.org.lab.rdpro.io.shapefile.ShapefileGeometryWriter
...
class ShapefileGeometryReaderTest extends FunSuite with org.apache.spark.test.beastSpatialTest {
  test("Read header") {
