...
import edu.ucr.cs.bdlab.beast.io.{GeoJSONFeatureReader, SilentJsonParser}
      ...
      token match {
        ...
        case JsonToken.FIELD_NAME =>
          ...
          fieldName.toLowerCase match {
            ...
            case "geometry" =>
              val geometry = GeoJSONFeatureReader.parseGeometry(jsonParser)
              ...
              while (jsonParser.nextToken != JsonToken.END_OBJECT) {
                ...
                try {
                  ...
                  case e: IllegalArgumentException =>
                    logWarning(s"Unexpected field '$name' in schema: ${schema.fieldNames.mkString(",")}")
                }
              }
