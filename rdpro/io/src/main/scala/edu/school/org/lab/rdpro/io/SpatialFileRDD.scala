...
import edu.school.org.lab.rdpro.cg.SpatialPartition
import edu.school.org.lab.rdpro.cg.SpatialDataTypes.SpatialRDD
import edu.school.org.lab.rdpro.common.BeastOptions
import edu.school.org.lab.rdpro.geolite.{EnvelopeND, EnvelopeNDLite, GeometryHelper, GeometryType, IFeature}
import edu.school.org.lab.rdpro.indexing.CellPartitioner
import edu.school.org.lab.rdpro.io.SpatialFileRDD.SpatialFilePartition
import edu.school.org.lab.rdpro.io.SpatialFileRDD.FilePartition
import edu.school.org.lab.rdpro.util.{IConfigurable, OperationParam}
 ...
 */
class SpatialFileRDD(@transient sc: SparkContext, path: String, var opts: BeastOptions = new BeastOptions())
  extends SpatialRDD(sc, Seq()) with Logging {

  opts = new BeastOptions(sc.hadoopConfiguration).mergeWith(sc.getConf).mergeWith(opts)
...
object SpatialFileRDD extends IConfigurable with Logging {
   ...
   */
  private[rdpro] def skipDuplicateAvoidance(rdd: RDD[_]): Unit = {
